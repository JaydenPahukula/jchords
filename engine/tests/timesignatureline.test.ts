...
describe('Parse time signature line', () => {
  test('plain 4/4', () => {
    const result = TimeSignatureLine.tryParse('4/4', 0);
  ...
  test('plain 6/8', () => {
    const result = TimeSignatureLine.tryParse('6/8', 0);
    expect(result).not.toBeNull();
  ...
  test('plain 1/2', () => {
    const result = TimeSignatureLine.tryParse('1/2', 0);
    expect(result).not.toBeNull();
  ...
  test('plain 12/8', () => {
    const result = TimeSignatureLine.tryParse('12/8', 0);
    expect(result).not.toBeNull();
  ...
  test('invalid character letter', () => {
    expect(TimeSignatureLine.tryParse('a/4', 0)).toBeNull();
  });

  test('extra characters', () => {
    expect(TimeSignatureLine.tryParse('4/4/4', 0)).toBeNull();
  });

  test('invalid character dot', () => {
    expect(TimeSignatureLine.tryParse('4.4', 0)).toBeNull();
  });
  ...
  test('empty line', () => {
    expect(TimeSignatureLine.tryParse('', 0)).toBeNull();
  });
});
